...
import com.miss.http.bean.BaseListResponse;
 ...
 * @param <T>
 */
public abstract class BaseObserverArrayListener<T> extends DisposableObserver<T> {
    @Override
    ...
    public void onNext(T t) {
        try {
            BaseListResponse baseResponse = (BaseListResponse) t;
            if (baseResponse.getCode()==200){
                onSuccess(((BaseListResponse) t).getData());
            }else {
