...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        TypedArray custom = context.obtainStyledAttributes(attrs, R.styleable.FlowLayout);
        horizontalSpacing = custom.getDimensionPixelSize(
                R.styleable.FlowLayout_wlyHorizontalSpacing, horizontalSpacing);
        verticalSpacing = custom.getDimensionPixelSize(
                R.styleable.FlowLayout_wlyVerticalSpacing, verticalSpacing);
        int gravity = custom.getInt(R.styleable.FlowLayout_wlyGravity, GRAVITY_TOP);
        custom.recycle();
