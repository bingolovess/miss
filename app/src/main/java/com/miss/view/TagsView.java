...
public class TagsView extends AutoCompleteTextView {
    ...
    public void setTagsTextSize(@DimenRes int textSize) {
        mTagsTextSize = getDimension(getContext(), textSize);
        setTags(convertTagSpanToArray(mTagSpans));
    }
    ...
    public void setCloseDrawablePadding(@DimenRes int padding) {
        mDrawablePadding = getDimensionPixelSize(getContext(), padding);
        setTags(convertTagSpanToArray(mTagSpans));
    }
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mTagsTextSize = getDimensionPixelSize(context, R.dimen.defaultTagsTextSize);
            mTagsBackground = ContextCompat.getDrawable(context, R.drawable.shape_tags_oval);
            mRightDrawable = ContextCompat.getDrawable(context, R.mipmap.tag_close);
            mDrawablePadding = getDimensionPixelSize(context, R.dimen.defaultTagsCloseImagePadding);
            mTagsPaddingRight = getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
            mTagsPaddingLeft = getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
            mTagsPaddingTop = getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
            mTagsPaddingBottom = getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
        } else {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TagsView, defStyleAttr, defStyleRes);
            try {
                mIsSpacesAllowedInTags = typedArray.getBoolean(R.styleable.TagsView_allowSpaceInTag, false);
                mTagsTextColor = typedArray.getColor(R.styleable.TagsView_tagsTextColor,
                        getColor(context, R.color.defaultTagsTextColor));
                mTagsTextSize = typedArray.getDimensionPixelSize(R.styleable.TagsView_tagsTextSize,
                        getDimensionPixelSize(context, R.dimen.defaultTagsTextSize));
                mTagsBackground = typedArray.getDrawable(R.styleable.TagsView_tagsBackground);
                mRightDrawable = typedArray.getDrawable(R.styleable.TagsView_tagsCloseImageRight);
                mLeftDrawable = typedArray.getDrawable(R.styleable.TagsView_tagsCloseImageLeft);
                mDrawablePadding = typedArray.getDimensionPixelOffset(R.styleable.TagsView_tagsCloseImagePadding,
                        getDimensionPixelSize(context, R.dimen.defaultTagsCloseImagePadding));
                mTagsPaddingRight = typedArray.getDimensionPixelSize(R.styleable.TagsView_tagsPaddingRight,
                        getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
                mTagsPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.TagsView_tagsPaddingLeft,
                        getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
                mTagsPaddingTop = typedArray.getDimensionPixelSize(R.styleable.TagsView_tagsPaddingTop,
                        getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
                mTagsPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.TagsView_tagsPaddingBottom,
                        getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
            } finally {
                typedArray.recycle();
            }
    ...
    private void setTags() {
        ...
        //setEditTextHintWithSize(this,""+getHint(),12);
     ...
     * @param size
     */
    public void setHintTextSize(@Dimension int size){
        setEditTextHintWithSize(this,getHint()+"",size);
    }
    /**
     * 设置EditText的hint字体大小
     *
