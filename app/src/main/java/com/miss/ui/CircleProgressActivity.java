...
import com.miss.progress.CircleProgressView;
import com.miss.view.CommonHeader;

public class CircleProgressActivity extends BaseActivity  implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener, CircleProgressView.CircleProgressUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonHeader.setTitle("进度环");
        initView();
    }

    private void initView() {
        csb_track_width = (AppCompatSeekBar) findViewById(R.id.csb_track_width);
        csb_start_progress = (AppCompatSeekBar)findViewById(R.id.csb_start_progress);
        csb_end_progress = (AppCompatSeekBar)findViewById(R.id.csb_end_progress);
        csb_text_size = (AppCompatSeekBar)findViewById(R.id.csb_text_size);
        csc_trackEnabled = (SwitchCompat)findViewById(R.id.csc_isTracked);
        csc_fillEnabled = (SwitchCompat)findViewById(R.id.csc_isFilled);
        csc_circleBroken = (SwitchCompat)findViewById(R.id.csc_circleBroken);
        csc_isGraduated = (SwitchCompat)findViewById(R.id.csc_isGraduated);
        circleProgressView = (CircleProgressView)findViewById(R.id.progressView_circle);
        btn_start = (Button)findViewById(R.id.cb_start);
