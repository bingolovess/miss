...
import com.miss.launch.sort.TaskSortUtil;
import com.miss.launch.stat.TaskStat;
import com.miss.launch.utils.DispatcherLog;
import com.miss.launch.utils.Utils;
...
public class TaskDispatcher {
    ...
    private void executeTaskMain() {
        ...
        DispatcherLog.i("main task cost " + (System.currentTimeMillis() - mStartTime));
    }
